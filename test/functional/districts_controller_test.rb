...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { abbv: @district.abbv, created_at: @district.created_at, division: @district.division, name: @district.name, updated_at: @district.updated_at }
    end
  ...
  test "should update district" do
    put :update, id: @district, district: { abbv: @district.abbv, created_at: @district.created_at, division: @district.division, name: @district.name, updated_at: @district.updated_at }
    assert_redirected_to district_path(assigns(:district))
  end
